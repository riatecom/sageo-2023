...
```bash
sudo apt install r-base curl libssl-dev libpq5 libclang-dev libudunits2-dev
```
...
- Ouvrir un terminal système (soit depuis *Finder*, ouvrir le dossier /Application/Utilitaires et cliquer deux fois sur *Terminal*, soit depuis l'icone *Launchpad* dans le Dock, saisir "Terminal" dans le champ de recherche, puis cliquer sur *Terminal*) et installer la bibliothèque *udunits*.
