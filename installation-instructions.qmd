...
- Nous contacter ([matthieu.viry@cnrs.fr](mailto:matthieu.viry@cnrs.fr)).

### Installation de R et des dépendances pour R Studio

```bash
sudo apt install r-base curl libssl-dev libpq5 libclang-dev libudunits2-dev libcurl4-openssl-dev libxml2-dev libpng-dev
```
